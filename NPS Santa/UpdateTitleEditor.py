...
# source: https://github.com/lazymacadmin/UpdateTitleEditor/blob/main/Processor/UpdateTitleEditor.py
...
class UpdateTitleEditor(PkgPayloadUnpacker, FlatPkgUnpacker):
    ...
    extracts all Information needed for updating Title Editor. The unpacked \
